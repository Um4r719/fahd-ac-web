document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    en: {
      ...
      service5Title: "Refrigator Repair",
      service5Desc: "Expert diagnosis and repair of all types of refrigerators, ensuring optimal cooling and long-lasting performance.",
    ...
    ar: {
      ...
      service5Title: "إصلاح الثلاجات",
      service5Desc: "التشخيص والإصلاح الخبير لجميع أنواع الثلاجات، وضمان التبريد الأمثل والأداء طويل الأمد.",
